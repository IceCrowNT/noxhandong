...
import { DEFAULT_CUSTOMER_COLUMN_ALIASES, MANAGEMENT_SHEET_NAMES } from "@/lib/constants";
import { CustomerRecord, ManagementWorkbookData } from "@/lib/types";
import { normalizeApartmentCode, normalizeHeader, safeString } from "@/lib/utils/text";
