...
:: Lenh dang ky vao Windows Task Scheduler
schtasks /Create /TN "Noxh_DB_Backup_2AM" /TR "powershell.exe -ExecutionPolicy Bypass -WindowStyle Hidden -File \"%SCRIPT_PATH%\"" /SC DAILY /ST 02:00 /RL HIGHEST /F
