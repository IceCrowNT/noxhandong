...
## Backlog tối ưu cuối kỳ

- [ ] Tùy chọn Không dán thông báo giấy theo từng căn hộ.
  - Không phải task chính của phase hiện tại.
  - Chỉ làm ở giai đoạn tinh chỉnh cuối trước khi vận hành ổn định.
  - Rule dự kiến:
    - có cờ nghiệp vụ riêng theo căn hộ;
    - checklist Excel vẫn hiện căn và tự ghi chú Không dán;
    - file Word tự loại căn đó khỏi danh sách in.