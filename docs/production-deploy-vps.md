...
- HTTPS: Let's Encrypt.
- App Next.js: chạy bằng Windows Service qua NSSM trong giai đoạn MVP; nếu chuyển Ubuntu thì dùng PM2 hoặc systemd.
...
- [x] Mua/chốt domain `noxhandong.vn`.
...
- [x] Chốt cách chạy app giai đoạn Windows MVP: NSSM service.
- [x] Chốt lịch `pg_dump` tự động: Windows Scheduled Task hằng ngày lúc 02:00.
...
Runbook thao tác: [deploy-vps-step-by-step.md](deploy-vps-step-by-step.md), đây là file xương sống cho deploy/vận hành VPS hiện tại.
