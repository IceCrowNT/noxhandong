...
- HTTPS: Let's Encrypt.
- App Next.js: chạy bằng process manager như `pm2` hoặc systemd service.
...
- [ ] Chốt nhà cung cấp VPS.
- [ ] Chốt cấu hình VPS tối thiểu.
- [ ] Mua/chốt domain `noxhandong.com`.
- [ ] Chốt reverse proxy: Nginx hoặc Caddy.
- [ ] Chốt cách chạy app: `pm2` hoặc systemd.
- [ ] Chốt lịch `pg_dump` tự động.
- [ ] Chốt nơi lưu file backup DB ngoài VPS.
- [ ] Thiết kế chức năng export Excel phục vụ lưu local.
